...
!             possibly followed by &DIST_XXX blocks 
...
! ARG: Tn       [dble] [0d0] Normal traction (positive = tensile)
! ARG: Tt       [dble] [0d0] Tangential traction (positive antiplane: y>0)
...
!       non uniform values to friction and initial stress parameters.
