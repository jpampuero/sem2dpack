...
! In SH with homogeneous medium properties and ngll/=OPT_NGLL
! minimizes memory usage by storing elastic coefficients only once
  logical, parameter :: OPT_HOMOG=.false. 
