...
! END INPUT BLOCK
  ...
  NAMELIST / SRC_RICKER / f0,onset,ampli

  f0    = 0.
  onset = 0.
  ampli = 1.

  read(iin,SRC_RICKER,END=100)
...
!    write(iout,'(A,EN12.3)') '             will be reset to t0 = ',onset
  ...
  100 call IO_abort('RICKER_read: SRC_RICKER input block not found')
  200 format(5x, & 
     'Function Type. . . . . . . . . . . . . = Ricker',/5x, &
     'Fundamental frequency (Hz) . . . . . . =',EN12.3,/5x, &
     'Time delay (s) . . . . . . . . . . . . =',EN12.3,/5x, &
     'Multiplying factor . . . . . . . . . . =',EN12.3)
