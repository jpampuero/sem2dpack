...
[npts,ndat,nsamp,dt] = textread('Flt05_sem2d.hdr','%n%n%n%n',1,'headerlines',1);
[x,z] = textread('Flt05_sem2d.hdr','%f%f','headerlines',4);

% Read fault data in a big matrix
fid=fopen('Flt05_sem2d.dat'); raw = fread(fid,[npts+2,inf],'single') ; fclose(fid);
