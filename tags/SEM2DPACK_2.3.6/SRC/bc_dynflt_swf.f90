...
! Read parameters from input file
  ...
  NAMELIST / BC_DYNFLT_SWF / kind,Dc,MuS,MuD,DcH,MuSH,MuDH,healing
...
300 continue
  ...
  if (echo_input) write(iout,400) kind_txt,DcH,MuSH,MuDH,healing
...
!=====================================================================
  ...
  if (f%healing) then
   ...
   !WARNING: valid only for leapfrog
    do k=1,size(v)
